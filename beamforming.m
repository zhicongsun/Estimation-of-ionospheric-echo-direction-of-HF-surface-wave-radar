function [abs_P]=beamforming(input)
 %{
...
function [abs_P]=capondbf()
%{
    Function description:
            Capon DBF算法，用于2D-DOA估计
    Syntax：
    Log description：
            2020.03.19  实现算法，相比普通波束形成提高分辨力
            2020.04.20  将二维三维方向图、三维功率谱图、二维功率谱图的实现注释，暂不使用
%}
    global g_signal;
    global g_array;
    global g_echos;
